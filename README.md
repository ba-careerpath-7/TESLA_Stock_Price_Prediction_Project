...
* **Short-term predictions** are generated using **machine learning models** like Linear Regression, which capture daily price changes.
* **Long-term forecasts** are produced using **time series models** such as **Prophet, SARIMA/SARIMAX, and custom State-Space models**, which account for trends, seasonal cycles, and uncertainty.
...
3. Generate insights and potential business applications, such as optimal buy/sell periods.
...
It highlights the importance of trends, seasonality, and uncertainty in stock prices and encourages exploring other datasets to generate actionable insights.
